...
const revenueService = {
  ...
  getRevenueOverview: async (startDate = null, endDate = null) => {
    try {
      let url = '/admin/revenue/overview';
  ...
  getRevenueByMonth: async (year, month) => {
    try {
      const response = await apiService.get(`/admin/revenue/monthly?year=${year}&month=${month}`);
      return response.data;
    } catch (error) {
  ...
  getRevenueByService: async (serviceId, startDate = null, endDate = null) => {
    try {
      let url = `/admin/revenue/service/${serviceId}`;
      const params = new URLSearchParams();
  ...
  getPaymentMethodStats: async (startDate = null, endDate = null) => {
    try {
      let url = '/admin/revenue/payment-methods';
      const params = new URLSearchParams();
  ...
  getTopServicesByRevenue: async (limit = 10, startDate = null, endDate = null) => {
    try {
      let url = `/admin/revenue/top-services?limit=${limit}`;
      const params = new URLSearchParams();
  ...
  getSampleRevenueData: async () => {
    try {
      const response = await apiService.get('/admin/revenue/sample');
      return response.data;
    } catch (error) {
